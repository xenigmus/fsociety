...
mrrobot = color.NOTICE + '''
Hello,
This is an pentesting framework developed for users who has
 been looking up for collection of tools used in the Mr. Robot series.
The series of tools will be added and updated till season 4 after 
 that this will the end of further development of this framework
  also bugs will resolved. log reports will be helpful. 

for further discussions join our discord server :
...
class fsociety:
    ...
    Yb      Yb   dP 88 Y88   88   88"Yb  88 88""Yb o.`Y8b
     ...
     ''')
        contributorsURL = 'https://api.github.com/repos/enigmaDEVELOPERZ/fsociety/contributors'
    ...
    def update(self):
        os.system("git clone --depth=1 https://github.com/enigmaDEVELOPERZ/fsociety.git")
...
class crips:
    ...
    def __init(self):
        ...
        self.gitRepo = "https://github.com/enigmaDEVELOPERZ/Crips.git"
